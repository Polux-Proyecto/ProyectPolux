 ...
 * @author rods2
 */
@WebServlet(name = "EliminaRegistros", urlPatterns = {"/EliminaRegistros"})
public class EliminaRegistros extends HttpServlet {
    ...
    protected void processRequest(HttpServletRequest request, HttpServletResponse response)
       ...
       switch(formid){
           case "25":{
               String deseo = request.getParameter("idprod");
               String user = request.getParameter("idusu");
               int iddeseo = Integer.parseInt(deseo);
               int iduser = Integer.parseInt(user);
               Boolean hasfailed;
               AdminProductos adminproducto = new AdminProductos();
